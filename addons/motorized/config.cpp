...
class CfgPatches {
  class SFT_motorized {
    units[] = {
      "SFT_B_UNSC_A_W_M12A", "SFT_B_UNSC_A_W_M12A_LAAG_M41", "SFT_B_UNSC_A_W_M831A"
    };
    requiredVersion = 0.1;
  };
};
...
class CfgVehicles
{
  ...
  class SFT_B_UNSC_A_W_M12A : TCP_B_UNSC_A_W_M12A
  {
    author = "Weber";
	...
	class SFT_B_UNSC_A_W_M12A_LAAG_M41 : TCP_B_UNSC_A_W_M12A_LAAG_M41
	{
		author = "Weber";
	...
	class SFT_B_UNSC_A_W_M831A : TCP_B_UNSC_A_W_M831A
	{
		author = "Weber";
		displayName = "[SFT] M12 LRV TT";
		faction = "SFT_BLUE_SFT_F";
		//crew = "SFT";
		class AcreRacks {
			class Rack_1 {
